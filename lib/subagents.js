...
export const SUBAGENT_RECIPES = {
  'kimi-agent': {
    ...
    toolFilter: { allow: ['Shell', 'ReadFile', 'WriteFile', 'StrReplaceFile', 'Glob', 'Grep', 'SearchWeb', 'FetchURL', 'ReadMediaFile', 'TaskList', 'TaskOutput', 'TaskStop', 'SetTodoList', 'EnterPlanMode', 'ExitPlanMode'] },
  },
  'kimi-explore': {
